...
Run: python playground/50_parameter_injection.py
...
class ParameterInjector:
    ...
    def __init__(self, path_template: str, handler: Callable):
        ...
        # Extract path parameter names from template like "/users/{user_id}"
    ...
    def inject(self, request: Request) -> dict[str, Any]:
        ...
        for name, param in self.sig.parameters.items():
            ...
            if isinstance(param.default, Depends):
                ...
                # Dependencies can themselves accept Request
