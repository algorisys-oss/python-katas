...
Run: python playground/skeletons/14_abstract_base_classes.py
...
class Circle(Shape):
    ...
    def area(self) -> float:
        # TODO: return the area of a circle (pi * r^2)
        # HINT: math.pi * self.radius ** 2
        pass

    def perimeter(self) -> float:
        # TODO: return the circumference (2 * pi * r)
        # HINT: 2 * math.pi * self.radius
        pass
...
class Triangle(Shape):
    ...
    def __init__(self, a: float, b: float, c: float):
        # TODO: validate triangle inequality, then store sides
        # HINT: if a + b <= c or a + c <= b or b + c <= a: raise ValueError(...)
        self.a = a
        self.b = b
        self.c = c
    ...
    def area(self) -> float:
        ...
        # HINT: s = (a+b+c)/2; return math.sqrt(s*(s-a)*(s-b)*(s-c))
        pass
...
# TODO: register JsonConfig as a virtual subclass of Serializable
# HINT: Serializable.register(JsonConfig)
...
class Renderable(ABC):
    ...
    def __subclasshook__(cls, C):
        # TODO: if cls is Renderable and C has a 'render' attribute, return True
        # Otherwise return NotImplemented
        # HINT: if cls is Renderable: if hasattr(C, "render"): return True
...
class TypedSet(TypedCollection):
    ...
    @property
    def element_type(self) -> type:
        # TODO: return self._type
        pass

    def add(self, item) -> None:
        # TODO: validate the item, then add to self._data
        # HINT: self.validate(item); self._data.add(item)
        pass
    ...
    def __iter__(self) -> Iterator:
        # TODO: return iter(self._data)
        pass

    def __contains__(self, item) -> bool:
        # TODO: return item in self._data
        pass
...
class Plugin(ABC):
    @classmethod
    def __subclasshook__(cls, C):
        # TODO: check if C has both 'name' and 'execute' attributes
        # HINT: if cls is Plugin: if hasattr(C, "name") and hasattr(C, "execute"): return True
        # return NotImplemented
        return NotImplemented
