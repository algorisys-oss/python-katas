...
Run: python playground/skeletons/42_path_parameters.py
...
class PathParam:
    ...
    def convert(self, raw: str) -> Any:
        ...
        # TODO: Try to call self.converter(raw) and return the result
        # TODO: Catch ValueError/TypeError and raise a new ValueError
        #       with a message like "Cannot convert '{raw}' to {self.type_name}
        #       for parameter '{self.name}'"
        # HINT: Use try/except with "raise ... from exc"
        pass
...
class CompiledRoute:
    ...
    def match(self, path: str) -> dict[str, Any] | None:
        ...
        # TODO: Use self.regex.fullmatch(path) to try matching
        # TODO: If no match, return None
        # TODO: If match, zip self.params with m.groups() and convert each
        #       value using param.convert(raw_value)
        # TODO: Return a dict mapping param names to converted values
        # HINT: result = {}; for param, raw in zip(...): result[param.name] = ...
        pass
...
def compile_path(pattern: str, handler: Callable,
    ...
    for match in PARAM_PATTERN.finditer(pattern):
        # TODO: Append re.escape() of the literal text between last_end
        #       and match.start() to regex_parts
        # HINT: regex_parts.append(re.escape(pattern[last_end:match.start()]))

        # TODO: Extract param_name from match.group(1)
        # TODO: Extract type_name from match.group(2), defaulting to "str"
        # HINT: type_name = match.group(2) or "str"

        # TODO: Validate type_name is in TYPE_COERCIONS, raise ValueError if not

        # TODO: Create a PathParam and append to params list
        # TODO: Append the corresponding TYPE_REGEXES[type_name] to regex_parts
        # TODO: Update last_end = match.end()
        pass

    # TODO: Append re.escape() of any trailing literal text after the last param
    # HINT: regex_parts.append(re.escape(pattern[last_end:]))

    # TODO: Build full_regex = "^" + "".join(regex_parts) + "$"
    # TODO: Return a CompiledRoute with re.compile(full_regex)
...
class Router:
    ...
    def add_route(self, method: str, pattern: str,
        ...
        # TODO: Use compile_path() to create a CompiledRoute
        # TODO: Append it to self._routes
        pass

    def get(self, pattern: str):
        """Decorator for GET routes."""
        # TODO: Return a decorator that calls self.add_route("GET", ...)
        # HINT: def decorator(func): self.add_route("GET", pattern, func); return func
    ...
    def resolve(self, method: str, path: str
        ...
        """
        # TODO: Iterate over self._routes
        # TODO: Skip routes where route.method != method.upper()
        # TODO: Call route.match(path) -- if it returns a dict, return
        #       (route.handler, params)
        # TODO: If no route matches, return None
        pass

    def handle(self, request: Request) -> Response:
        """Dispatch a request to the appropriate handler."""
        # TODO: Call self.resolve(request.method, request.path)
        # TODO: If None, return Response(status=404, body="Not Found")
        # TODO: Otherwise unpack (handler, params), set
        #       request.path_params = params,
        #       and return handler(request, **params)
        pass
