...
Run: python playground/skeletons/61_pubsub.py
...
class Message:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # TODO: Return a dict with "topic" and "payload" always included
        # Include "publisher_id" only if self.publisher_id is not None
        # Include "metadata" only if self.metadata is non-empty
        pass
...
class Subscription:
    ...
    def matches(self, topic: str) -> bool:
        ...
        # TODO: If this is a pattern subscription, use fnmatch.fnmatch
        # Otherwise check for exact equality
        # HINT: fnmatch.fnmatch(topic, self.topic_or_pattern)
        pass
...
class PubSub:
    ...
    def subscribe(
        ...
        """
        # TODO: Create a Subscription with is_pattern=False
        # Add it to self._subscriptions[topic] (create list if needed)
        # Add it to self._by_subscriber[subscriber_id] (create list if needed)
    ...
    def psubscribe(
        ...
        """
        # TODO: Create a Subscription with is_pattern=True
        # Add it to self._pattern_subscriptions
        # Add it to self._by_subscriber[subscriber_id]
        # Return the subscription
        pass
    ...
    def unsubscribe(self, subscriber_id: str, topic: str | None = None) -> int:
        ...
        """
        # TODO: Find all subscriptions for this subscriber_id
        # If topic is specified, only remove matching ones
        # Remove from self._subscriptions or self._pattern_subscriptions
        # Clean up empty lists
        # Return the count of removed subscriptions
        pass
    ...
    async def publish(
        ...
        # Deliver to all exact topic subscribers in self._subscriptions[topic]
        # Deliver to all matching pattern subscribers
        # Call await sub.callback(message) and increment sub.message_count
        # Return the total number delivered
        pass
...
class WebSocketPubSub:
    ...
    def unregister(self, ws: MockWebSocket) -> None:
        ...
        # TODO: Unsubscribe the client from all topics
        # Remove from self._websockets
        pass

    async def subscribe(self, ws: MockWebSocket, topic: str) -> Subscription:
        """Subscribe a WebSocket client to a topic."""
        # TODO: Create a callback that sends message.to_dict() as JSON
        # to the WebSocket when a message is published
        # Then call self.pubsub.subscribe(topic, ws.client_id, callback)
        pass

    async def psubscribe(self, ws: MockWebSocket, pattern: str) -> Subscription:
        """Subscribe a WebSocket client to a pattern."""
        # TODO: Same as subscribe but use self.pubsub.psubscribe
        pass
