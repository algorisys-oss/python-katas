"""
Kata 41 -- Router
Run: python playground/skeletons/41_router.py
...
class Route:
    ...
    def matches(self, method: str, path: str) -> bool:
        ...
        # TODO: Compare self.method with method.upper() AND self.path with path
        # HINT: return self.method == method.upper() and self.path == path
        pass
...
class Router:
    ...
    def add_route(self, method: str, path: str, handler: callable) -> None:
        ...
        # TODO: Create a Route and append it to self.routes
        # HINT: self.routes.append(Route(method, path, handler))
        pass
    ...
    def route(self, path: str, methods: list[str] | None = None) -> callable:
        ...
        def decorator(handler: callable) -> callable:
            # TODO: Call self.add_route for each method in methods
            # HINT: for method in methods: self.add_route(method, path, handler)
            return handler
    ...
    def get(self, path: str) -> callable:
        ...
        # TODO: Return self.route(path, methods=["GET"])
        pass

    def post(self, path: str) -> callable:
        """Decorator shortcut for POST routes."""
        # TODO: Return self.route(path, methods=["POST"])
        pass

    def put(self, path: str) -> callable:
        """Decorator shortcut for PUT routes."""
        # TODO: Return self.route(path, methods=["PUT"])
        pass

    def delete(self, path: str) -> callable:
        """Decorator shortcut for DELETE routes."""
        # TODO: Return self.route(path, methods=["DELETE"])
        pass
    ...
    def _find_routes_for_path(self, path: str) -> list[Route]:
        ...
        # TODO: Return a list of routes where route.path == path
        # HINT: return [r for r in self.routes if r.path == path]
        pass

    def _find_route(self, method: str, path: str) -> Route | None:
        """Find the exact route matching method + path."""
        # TODO: Loop through self.routes, return the one where r.matches(method, path)
        # HINT: for r in self.routes:
    ...
    async def dispatch(self, request: Request) -> Response:
        ...
        # TODO: Try to find an exact route match
        # HINT: route = self._find_route(method, path)
        #       if route is not None:
        #           return await route.handler(request)

        # TODO: If path exists but wrong method -> 405 with allowed methods
        # HINT: routes_for_path = self._find_routes_for_path(path)
        #       if routes_for_path:
        ...
        # TODO: No matching path at all -> 404
        # HINT: return JSONResponse(
    ...
    async def __call__(self, scope: dict, receive: callable, send: callable) -> None:
        ...
        Creates a Request from scope/receive, dispatches it,
        and sends the resulting Response.
        """
        # TODO: Create a Request, dispatch it, call response with scope/receive/send
        # HINT: request = Request(scope, receive)
...
async def main():
    ...
    if router is not None:
        ...
        print("  ❌ Skipped: router not available (Section 1 failed)")
    print()
